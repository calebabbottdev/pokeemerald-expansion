...
#define B_VAR_STARTING_STATUS       VAR_STARTING_STATUS     // If this var has a value, assigning a STARTING_STATUS_xx_xx to it before battle causes the battle to start with that terrain active.
